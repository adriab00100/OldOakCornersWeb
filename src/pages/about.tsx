  ...
  <Layout>
    ...
    <div>
      <section>
        ...
        <p>
          I want to share my projects with the general public because I was inspired to get into this hobby by looking
          through similar blogs. I figure here I might be able to inspire someone else to pick up the saw and get in to
          this themselves. I also hope that my projects that I show can provide ideas that others can build on, or reuse
          for their own needs.
        </p>
        <p>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <ExternalLink href="https://christophermschwarz.com/">Christopher Schwartz</ExternalLink> is a furniture
            maker, author, and also researchers traditional woodworking techniques
          </li>
          <li>
            <ExternalLink href="https://www.youtube.com/watch?v=lrAAglKLPh8">Frank Klausz</ExternalLink> is a master
            jointer with many videos on YouTube
          </li>
        </ul>
        <p>
          There are loads more interesting people sharing their work on YouTube and Facebook, so I encourage you to look
          around.
        </p>
      </section>
      <section>
        ...
        <Container type="side-by-side">
          <div>
            <p>
              ...
              using <ExternalLink href="https://cloudinary.com/">Cloudinary</ExternalLink> for all my image and video
              needs.
            </p>
            <p>
