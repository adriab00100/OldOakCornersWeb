  ...
  <Layout>
    ...
    <div>
      <section>
        ...
        <p>Any advice I provide, or designs I share are free to use at your own risk. I&apos;m not an expert, and not a professional, but I sure do love the craft!</p>
      </section>
      <section>
        <h2>About Brian</h2>
        <p>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            <ExternalLink href="https://christophermschwarz.com/">Christopher Schwartz</ExternalLink> is a furniture maker, author, and also researchers traditional woodworking
            techniques
          </li>
          <li>
